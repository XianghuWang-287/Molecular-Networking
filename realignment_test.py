    ...
    for library in libraries:
        ...
        for item in new_list:
            if (item != None):
                ...
                smile1=cluster_summary_df.loc[cluster_summary_df['scan']==item[0]]["spectrum_id"].values[0]
                smile2=cluster_summary_df.loc[cluster_summary_df['scan']==item[1]]["spectrum_id"].values[0]
                print(item[0],item[1])
                print(smile1)
                print(smile2)
                print(comp_structure_dic(cluster_summary_df,item[0],item[1],dic_fp))
        y_weight_avg = []
        components_all_list = []
        results_df_list = []
